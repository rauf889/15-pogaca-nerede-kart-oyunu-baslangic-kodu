...
<div class="game-area">
    ...
    <h4 class="description">Acik kartlardan birini sectikten sonra, kapali olan karta tiklayiniz</h4>
    <div class="container">
...
<style scoped>
    ...
    /*******Acik kartlarin animasyonlari icin gerekli olan transition class tanimlari*******/
    ...
    /*******Kapali kartlarin animasyonlari icin gerekli olan transition class tanimlari*******/
